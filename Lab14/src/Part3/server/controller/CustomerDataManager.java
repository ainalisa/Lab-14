...
public class CustomerDataManager {
	...
	private List<Customer> createCustomer() {
		...
		String names[] = {"Aina Khaliesa", "Fatin Aqilah", 
						  "Umairah Hamir", "Syazwina",
						  "Nur Ezzany", "Nur Zulaikha Afza",
						  "Nur Amelia Asyiqin", "Anis Sofia",
						  "Aliah Batrisyia", "Nur Syahiratullah"};
